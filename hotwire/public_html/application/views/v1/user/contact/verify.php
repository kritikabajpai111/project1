...
<head>
    <meta charset="utf-8">
    <title>HWC REST API - User/Contact/Verify - Testing Server</title>
...
<div id="container">
    <h1><span class="header">
        ...
        <span>REST API - Testing Server - User/Contact/Verify</span>
    </span></h1>

    <div id="body">

<h2>User/Contact/Verify</h2>

        <h3>/v1/user/contact/verify/send - [GET/POST]</h3>
            ...
            <table>
                ...
                <tr>
                    ...
                    <div class="endpoint" id="send_code_endpoint">
                        http://<?=$_SERVER['HTTP_HOST']?>/v1/user/contact/verify/send/{phone or email}/format/{format}
                    </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <div class="form_response hidden" id="send_form_response">
...
<br><br>
        ...
        <h3>/v1/user/contact/verify/phone - [GET]</h3>
            ...
            <table>
                ...
                <tr>
                    ...
                    <div class="endpoint" id="verify_phone_endpoint">
                        http://<?=$_SERVER['HTTP_HOST']?>/v1/user/contact/verify/phone/{phone}/code/{code}/format/{format}
                    </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <div class="form_response hidden" id="verify_phone_form_response">
                        <pre>(Response displayed here)</pre>
                    </div>
                    </td>
                </tr>
...
<br><br>
        ...
        <h3>/v1/user/contact/verify/email - [GET]</h3>
            ...
            <table>
                ...
                <tr>
                    ...
                    <div class="endpoint" id="verify_email_endpoint">
                        http://<?=$_SERVER['HTTP_HOST']?>/v1/user/contact/verify/email/{email}/code/{code}/format/{format}
                    </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <div class="form_response hidden" id="verify_email_form_response">
                        <pre>(Response displayed here)</pre>
                    </div>
                    </td>
                </tr>
...
$(document)
    ...
    .on('click', '#send_submit', function(){
        ...
        var endpoint = '/v1/user/contact/verify/send/'+$('#send').val()+'/format/'+$('#format').val();
        $('#send_code_endpoint').html('http://<?=$_SERVER['HTTP_HOST']?>'+endpoint);
        if ($('#method').val()=='POST') {
...
/*            else {
            ...
            $('#send_form_response').children().html("Response Data Size: "+data.length+"\n"+data);
		});
        } else {
    ...
    .on('click', '#verify_phone_submit', function(){
        ...
        var endpoint = '/v1/user/contact/verify/phone/'+$('#phone').val()+'/code/'+$('#phone_code').val()+'/format/'+$('#verify_phone_format').val();
        $('#verify_phone_endpoint').html('http://<?=$_SERVER['HTTP_HOST']?>'+endpoint);
        $.get(endpoint,data,function(req) {
            ...
            var data = JSON.stringify(req, null, '\t');
            $('#verify_phone_form_response').children().html("Response Data Size: "+data.length+"\n"+data);
		});
    ...
    .on('click', '#verify_email_submit', function(){
        ...
        $('#verify_email_endpoint').html('http://<?=$_SERVER['HTTP_HOST']?>'+endpoint);
        $.get(endpoint,data,function(req) {
            ...
            var data = JSON.stringify(req, null, '\t');
            $('#verify_email_form_response').children().html("Response Data Size: "+data.length+"\n"+data);
		});
